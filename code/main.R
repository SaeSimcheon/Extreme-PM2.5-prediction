...
for (j in region_name){
  ...
  if(j == "양천구"){print(TSL_perf_en)}
  #TSL_perf_vote=voting_validation_tool(as.vector(true_y)[7:dim(TSL_perf$Q3StageP)[1]],TSL_perf$Q3StageP[7:dim(TSL_perf$Q3StageP)[1],])
